/* ============================================================
   00_SETUP  |  00_Reset_All.js   (ONE-CLICK RESET)
   ------------------------------------------------------------
   Drops + recreates the companyDB database, collections, indexes
   and data. Run this ANY time you want a clean starting point
   (for example after Level 05 Updates or Level 14 Transactions
   changed the data).

   This file is simply 01 + 02 joined together.
   HOW TO RUN (terminal):  mongosh --file 00_Reset_All.js
   HOW TO RUN (mongosh):   load("E:/Practice/MongoDB/00_Setup/00_Reset_All.js")
