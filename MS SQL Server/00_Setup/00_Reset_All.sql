/* ============================================================
   00_SETUP  |  00_Reset_All.sql   (ONE-CLICK RESET)
   ------------------------------------------------------------
   Drops + recreates the SQLPractice database, tables and data.
   Run this ANY time you want a clean starting point (for example
   after Level 04 CRUD or Level 16 Transactions changed the data).

   This file is simply 01 + 02 + 03 joined together.
   HOW TO RUN (SSMS):   open -> F5
   HOW TO RUN (sqlcmd): sqlcmd -S localhost -E -C -i "00_Reset_All.sql"
   ============================================================ */
/* ============================================================
